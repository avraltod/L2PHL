...
Strata are defined geographically. Seventeen of the eighteen regions each
contribute two strata, an urban stratum and a rural stratum, giving 34 strata.
The eighteenth region, the Bangsamoro Autonomous Region in Muslim Mindanao
(BARMM), instead enters through five special geographic areas carrying region
codes 101 through 105, each its own stratum. Together these give 39 strata in
total.
...
The module-by-module rationale for each weight assignment follows the weighting
technical note cited above, which documents both the construction and the intended
use of each weight.
