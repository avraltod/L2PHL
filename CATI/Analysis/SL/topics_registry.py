...
TOPICS = [
  ...
  {"slug":"lifelines","nav":"Lifelines","title":"Lifelines","modules":"Finance",
   "headline":"Christmas remittance surge","accent":"#FCD116","live":True,"indicators":["got_remit"]},
  ...
  {"slug":"uneven","nav":"Uneven","title":"Uneven recovery","modules":"By income & region",
   "headline":"The recovery flowed upward","accent":"#009FDA","live":True,"indicators":["food_insecurity","mobile_money"]},
  {"slug":"health","nav":"Health","title":"Health under pressure","modules":"Health",
   "headline":"Out-of-pocket 61% → 44%","accent":"#002244","live":True,"indicators":["oop"]},
